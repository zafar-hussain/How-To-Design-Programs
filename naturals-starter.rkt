...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname naturals-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; returns the sum of all numbers from

;(define (sum-upto n) 0)         ; stub
(check-expect (sum-upto 0) 0) ; basecase
(check-expect (sum-upto 2) 3)
...
;; func : number -> listOfNumbers
;; returns a list of numbers from n, n-1 to 0

;(define (list2N N) '())       ; stub
(check-expect (list2N 0) '()) ; basecase
(check-expect (list2N 2) (list 2 1))
