...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |Sorting Quickly|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;; quick-sort
